...
/**
 * Created by DustinK on 10/6/2016.
 */

public class BurlingtonFragment extends Fragment
{
    private static final String TAG = "BurlingtonFragment";
    ...
    private Question[] mQuestionBank = new Question[]
            {
                    new Question(R.string.burlington_question_ben_and_jerrys, 1),
                    new Question(R.string.burlington_question_centennial_field, 1),
                    new Question(R.string.burlington_question_church_street, 1),
                    new Question(R.string.burlington_question_farmers_market, 1),

                    //Start Multiple Choice
                    new Question(R.string.burlington_question_this_is_what, 1),
                    new Question(R.string.burlington_question_this_is_what, 1),
                    new Question(R.string.burlington_question_this_is_what, 1),

                    //Start enter name
                    new Question(R.string.burlington_question_name, 1),
                    new Question(R.string.burlington_question_name, 1),
                    new Question(R.string.burlington_question_name, 1),
            };
    ...
    private int[] imageList = new int[]
            {
                    R.drawable.burlington_benandjerry,
                    R.drawable.burlington_centennialfield,
                    R.drawable.burlington_churchstreet,
                    R.drawable.burlington_farmersmarket,

                    //Start Multiple Choice At 5th Question
                    R.drawable.burlington_macysmall,
                    R.drawable.burlington_mainstreet,
                    R.drawable.burlington_mrmikes,

                    //Start enter name at 8th question
                    R.drawable.burlington_skatepark,
                    R.drawable.burlington_threeneeds,
                    R.drawable.burlington_waterfront,
            };

    private int[] multipleChoiceAnswers = new int[]
            {
                    R.string.burlington_question_macys_mall,
                    R.string.burlington_question_main_street,
                    R.string.burlington_question_mr_mikes,
                    R.string.burlington_question_adog_skate_park,
            };
    ...
    private void scoreScreen()
    {
        ...
        //Burlington Score File
        String filenameBurlington = "project1scorefileburlington.txt";
        FileOutputStream outputStreamBurlington;
        int readInScoreBurlington = 0;
        String readInStringFirstBurlington = "";
        String readInStringSecondBurlington = "";
        int totalScoreToWriteBurlington = 0;

        try
        {
            FileInputStream fin = getActivity().openFileInput(filenameBurlington);

            while( (readInScoreBurlington = fin.read()) != -1)
            {
                readInStringFirstBurlington = readInStringFirstBurlington + Character.toString((char) readInScoreBurlington);
            }
        }
        catch(Exception e)
        {
        ...
        try
        {
            readInScoreBurlington = new Integer(Integer.parseInt(readInStringFirstBurlington));
            totalScoreToWriteBurlington = mNumberOfQuestionsCorrect + readInScoreBurlington;
        }
        catch(Exception e)
        {
            e.printStackTrace();
        ...
        String totalScoreBurlington = Integer.toString(totalScoreToWriteBurlington);

        try
        {
            outputStreamBurlington = getActivity().openFileOutput(filenameBurlington, Context.MODE_PRIVATE);
            outputStreamBurlington.write(totalScoreBurlington.getBytes());
            outputStreamBurlington.close();
        }
        catch (Exception e)
        {
            e.printStackTrace();
        ...
        try
        {
            ...
            while( (readInScoreBurlington = fin.read()) != -1)
            {
                readInStringSecondBurlington = readInStringSecondBurlington + Character.toString((char) readInScoreBurlington);
            }
        }
        catch(Exception e)
        {
    ...
    private void giveHint()
    {
        if(!mHintUsed)
        {
            ...
            {
                mMessagesTextView.setText("The Name Starts With 'Ska'");
            }
            else if(mCurrentIndex == 8)
            {
                mMessagesTextView.setText("The Name Starts With 'Thr'");
            }
            else if(mCurrentIndex == 9)
            {
                mMessagesTextView.setText("The Name Starts With 'Wat'");
            }
        }
    }
